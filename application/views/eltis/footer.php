  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2018 <a href="#">Sergey Tarasov</a>.</strong> All rights reserved.
    
    <div class="btn-group dropup">
      <button type="button" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        <?php echo img($flag_picture);?> <span class="caret"></span>
      </button>
...
<!-- AdminLTE App -->
<script src="<?php echo base_url();?>/design/js/adminlte.js"></script>
