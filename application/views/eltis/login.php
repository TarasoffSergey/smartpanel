...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <p class="login-box-msg"><?php echo lang('gui_login_input_your_data'); ?></p>

    <form action="<?php echo base_url();?>welcome/" method="post">
    
      <?php echo form_error('user_email'); ?>
      <div class="form-group has-feedback">
        <input name="user_email" type="email" class="form-control" placeholder="<?php echo lang('gui_login_enter_email');?>" value="<?php echo set_value('user_email'); ?>">
      ...
      <div class="row">
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <label>
              <input name="remember_me" type="checkbox"> <?php echo lang('gui_login_remember_me');?>
            </label>
          </div>
        </div>
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" class="btn btn-primary btn-block btn-flat"><?php echo lang('gui_login_login');?></button>
        </div>
        <!-- /.col -->
      </div>
    </form>
    ...
    <a href="#"><?php echo lang('gui_login_forgot_password');?></a><br>
    <a href="<?php echo base_url();?>welcome/register/" class="text-center"><?php echo lang('gui_login_create_account');?></a><br>
